...
export const loginUser = catchAsync(async (req, res, next) => {
    ...
    const user = await User.findOne({ email: email }).select("+password +isValidated"); //select use to get the password from DB eventhough they are on selected by default refer to password in userModel
...
function filterObjectsForUpdateUser(reqBodyObject, ...allowedFields) {
    const newObjects = {};
