...
export const RelevantAccount = ({ comments, author }: RelevantAcc) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="  flex mt-6  bg-slate-900 hover:bg-slate-600 p-4 rounded-b-xl"
      ...
      {releventUser.slice(0, 4).map((comment) => (
        <div
          ...
          >
            ...
            <div className="flex-1 flex flex-col ">
              {comment.id === author.id ? (
                ...
                <p className="text-lg font-medium px-4 hover:bg-slate-600 flex flex-col items-start justify-center h-full">
                  {comment.name}
                </p>
              )}
              <p className="text-base px-4 hover:bg-slate-600 flex flex-col items-start text-gray-400 justify-center h-full">
